...
class Secp256k1:
    ...
    def get_signature_from_private_key(self, private_key: EllipticCurvePrivateKey, mnemonic: bytes)-> bytes:
    ...
    def get_private_key(self) -> EllipticCurvePrivateKey:
        ...
        return private_key
    def get_public_key(self, private_key: EllipticCurvePrivateKey):
        public_key = private_key.public_key().public_bytes(Encoding.PEM, 'OpenSSH')
